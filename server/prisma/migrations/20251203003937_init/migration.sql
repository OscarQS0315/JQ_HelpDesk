...
CREATE TABLE `AutoTriageRule` (
    ...
    `technicianSpecialityId` INTEGER NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `Ticket` (
    ...
    `slaReply` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
    `slaResolution` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `Notification` (
    ...
    `ticketId` INTEGER NULL,
    `type` ENUM('LOGIN', 'TICKET_UPDATE') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
